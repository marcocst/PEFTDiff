...
def parse_args(input_args=None):
    ...
    parser.add_argument("--local_ank", type=int, default=-1, help="For distributed training: local_rank")
    ...
    # oft
    parser.add_argument("--oft_block_size", type=int, default=16, help=("Number of blocks in OFT."),)
    parser.add_argument("--butterfly_factor", type=int, default=1)
...
def main(args):
    ...
    unet_lora_config = BOFTConfig(
        boft_block_size=args.oft_block_size,
        boft_n_butterfly_factor=args.butterfly_factor,
        bias='none',
        boft_dropout=0.0,
    ...
    text_lr = (
        args.learning_rate if args.text_encoder_lr is None else args.text_encoder_lr
    )
    ...
    params_to_optimize = (
        [
            ...
            {"params": text_lora_parameters_one, "lr": text_lr},
            {"params": text_lora_parameters_two, "lr": text_lr},
        ]
